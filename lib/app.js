...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppJsx = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactImageGallery = __webpack_require__(179);
	...
	var _AppCSSJs = __webpack_require__(200);

	var _AppCSSJs2 = _interopRequireDefault(_AppCSSJs);
	...
	var App = (function (_React$Component) {
	  ...
	  function App() {
	    ...
	    this.handleHashChange = function () {
	      var number = parseInt(location.hash.replace('#', ''));
	      if (_this.refs.gallery) {
	        _this.refs.gallery.slideToIndex(number - 1);
	      }
	    };
	    ...
	    this.handleKeyDown = function (e) {
	      var gallery = _this.refs.gallery;
	      var _state = _this.state;
	      var showThumbnails = _state.showThumbnails;
	  ...
	  App.prototype.render = function render() {
	    ...
	    var showThumbnails = _state2.showThumbnails;
	    var index = _state2.index;
	    var autoPlay = _state2.autoPlay;

	    var currentImage = images[index];
	    return _react2['default'].createElement(
	      'div',
	      { style: style.wrapper },
	      _react2['default'].createElement(_radium.Style, { rules: _AppCSSJs2['default'] }),
	      _react2['default'].createElement(
	        'div',
	        { style: style.playControl },
	        _react2['default'].createElement('i', { onClick: this.handlePlayPause, className: 'fa fa-' + (autoPlay ? 'pause' : 'play') })
	      ),
	      currentImage && _react2['default'].createElement(
	        'div',
	        { style: style.text },
	        currentImage.text
	      ),
	      _react2['default'].createElement(_reactImageGallery2['default'], { autoPlay: autoPlay, showThumbnails: showThumbnails, onSlide: this.handleSlide, ref: 'gallery', items: images })
	    );
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S, 'Object', {setPrototypeOf: __webpack_require__(14).set});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSwipeable = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Enhancer = __webpack_require__(182);

	module.exports = function (ComposedComponent) {
	  return Enhancer(ComposedComponent);
	};
	module.exports.Style = __webpack_require__(192);
	module.exports.PrintStyleSheet = __webpack_require__(194);
	module.exports.getState = __webpack_require__(185);
	module.exports.keyframes = __webpack_require__(195);
	module.exports.Config = __webpack_require__(190);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var resolveStyles = __webpack_require__(183);
	var printStyles = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MouseUpListener = __webpack_require__(184);
	var getState = __webpack_require__(185);
	var getStateKey = __webpack_require__(186);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExecutionEnvironment = __webpack_require__(188);
	var arrayFind = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createMarkupForStyles = __webpack_require__(193);
	var Prefixer = __webpack_require__(187);
